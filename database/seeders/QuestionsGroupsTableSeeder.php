...
class QuestionsGroupsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('questions_groups')->insert([
            0 => [
                'id' => 1,
                'en_name' => 'Content and Organization of Course',
                'bn_name' => 'কোর্সের বিষয়বস্তু এবং কাঠামো',
                'created_at' => '2026-01-22 22:20:56',
                'updated_at' => '2026-01-22 22:20:56',
            ],
            1 => [
                'id' => 2,
                'en_name' => 'Teaching Methods',
                'bn_name' => 'শিক্ষাদান পদ্ধতি',
                'created_at' => '2026-01-22 22:22:16',
                'updated_at' => '2026-01-22 22:22:16',
            ],
            2 => [
                'id' => 3,
                'en_name' => 'Teaching-learning Environment',
                'bn_name' => 'শিক্ষাদান এবং শিক্ষণ পরিবেশ',
                'created_at' => '2026-01-22 22:23:50',
                'updated_at' => '2026-01-22 22:23:50',
            ],
            3 => [
                'id' => 4,
                'en_name' => 'Effectiveness of the Course',
                'bn_name' => 'কোর্সের কার্যকারিতা',
                'created_at' => '2026-01-22 22:25:04',
                'updated_at' => '2026-01-22 22:25:04',
            ],
        ]);
